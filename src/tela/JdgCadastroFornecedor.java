 ...
 * @author Mileto
 */
public class JdgCadastroFornecedor extends javax.swing.JDialog {
    ...
    Fornecedor fornecedor = new Fornecedor(cidade);

    public JdgCadastroFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        popularComboBox();
        mascaraCpfCnpj();
    ...
    private void initComponents() {
        ...
        setTitle("EasyPDV - Cadastro Fornecedor");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Fornecedor", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(51, 0, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int auxIdCidade = fornecedor.getCidade().getId();
        String auxDescricaoCidade = fornecedor.getCidade().getDescricao();
        //System.out.println(fornecedor.getCidade().getId() + "Id antes...");
        cidade.setAtivo('T');
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (verificarCadastrado()) {
            if (validarCampos()) {
                ...
                fornecedor.setCpfCnpj(tffCpfCnpj.getText().replace(".", "").replace("/", "").replace("-", ""));
                if (fornecedor.getTelefone() != "null") {
                    fornecedor.setTelefone(tffTelefone.getText().replace("(", "").replace(")", "").replace("-", ""));
                }
                ...
                if (cbxTipo.getSelectedIndex() == 0) {
                    fornecedor.setTipoCadastro('F');
                } else {
                    fornecedor.setTipoCadastro('J');
                }
                ...
                limparCampos();
                JOptionPane.showMessageDialog(null, "Cadastro de fornecedor salvo com sucesso!");
            } else {
                JOptionPane.showMessageDialog(null, "Erro ao salvar fornecedor, campos inválidos ou nulos");
    ...
    private void btnLocalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocalizarActionPerformed
        limparCampos();
        JdgListaFornecedor fornecedores = new JdgListaFornecedor(null, true, fornecedor, cidade);
    ...
    private void verificarCadastroSelecionado() {
        ...
        if (fornecedor.getId() > 0) {
            ...
            tfdRazaoSocial.setText(fornecedor.getRazaoSocial());
            tfdCidade.setText(fornecedor.getCidade().getDescricao());
            tfdEndereco.setText(fornecedor.getEndereco());
            tffCpfCnpj.setText(fornecedor.getCpfCnpj());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdgCadastroFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdgCadastroFornecedor dialog = new JdgCadastroFornecedor(new javax.swing.JFrame(), true);
